...
class TrainALL(tune.Trainable):
    def get_dataloader(self):
        ...
        elif self.dataset_name == 'Gosip':
            import data_process_Gosip as pro
        else:
        ...
        test_loader = DataLoader(dataset=test_dataset,
                                 ...
                                 num_workers=0)  # test时候不能扔掉last batch
    ...
    def setup(self, config):
        ...
        # self.CASED = 'E:/code project/Reproduction_of_MCAN-main/models/bert-base-chinese'  # multilingual-cased
        # self.VOCAB = 'E:/code project/Reproduction_of_MCAN-main/models/bert-base-chinese/vocab.txt'

        self.CASED = 'E:/code project/Reproduction_of_MCAN-main/models/bert-base-multilingual-cased'  # multilingual-cased
        self.VOCAB = 'E:/code project/Reproduction_of_MCAN-main/models/bert-base-multilingual-cased/vocab.txt'

        self.pthfile = 'E:/code project/Reproduction_of_MCAN-main/models/vgg19-dcbb9e9d.pth'
    ...
    def print_result_table_handler(self, loss_values, acc_values,
        ...
        # 这个地方需要绝对路径，不能使用相对路径
        if not os.path.exists('E:/code project/Reproduction_of_MCAN-main/results'):
            os.makedirs('E:/code project/Reproduction_of_MCAN-main/results')
        f_result = open(
            'E:/code project/Reproduction_of_MCAN-main/results/{}_accuracy.txt'.format(
                self.dataset_name), 'a+')
    ...
    def condition_save(self, epoch_index, test_epoch_acc, report):
        ...
        if self.dataset_name == 'twitter' or 'Gosip':
...
class TrialTerminationReporter(CLIReporter):
    ...
    def should_report(self, trials, done=False):
        ...
        old_num_terminated = self.num_terminatedf
...
if __name__ == '__main__':
    ...
    # grid search - weibo
    local_dir_root = 'E:/code project/Reproduction_of_MCAN-main/models/log/'
    repeat_times = 1
    max_concurrent = 1
    avg_metric = AvgMetricCallback()

    try:
        pickle.dumps(TrainALL)
    ...
    analysis = tune.run(
        ...
        config={
            ...
            # "dataset_name": tune.grid_search(['Gosip']),
            # "max_sen_len": tune.grid_search([1000]),
