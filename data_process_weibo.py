...
data_path = 'E:\code project\Reproduction_of_MCAN-main\weibo_dataset'
new_train = 'E:\code project\Reproduction_of_MCAN-main\processd_data\weibo/train.txt'
new_test = 'E:\code project\Reproduction_of_MCAN-main\processd_data\weibo/test.txt'
